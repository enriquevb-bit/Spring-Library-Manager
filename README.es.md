...
### Opción 1: Client Credentials (recomendada para pruebas con Postman)
...
### Opción 2: Authorization Code (flujo interactivo con login)

Este flujo redirige a una página de login donde introduces usuario y contraseña.

1. Configura la autorización de la colección con estos campos:
...
2. Haz clic en **Get New Access Token**.
3. Se abrirá una ventana del navegador con el formulario de login. Usa las siguientes credenciales:
...
4. Acepta el consentimiento de los scopes solicitados.
5. Postman recibirá el token. Haz clic en **Use Token**.
...
### application.properties (Desarrollo con H2) - backend-principal
